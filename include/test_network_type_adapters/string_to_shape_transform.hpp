...
#ifndef TEST_NETWORK_TYPE_ADAPTERS__STRING_TO_SHAPE_ADAPTER_HPP_
#define TEST_NETWORK_TYPE_ADAPTERS__STRING_TO_SHAPE_ADAPTER_HPP_
...
#endif  // TEST_NETWORK_TYPE_ADAPTERS__STRING_TO_SHAPE_ADAPTER_HPP_
